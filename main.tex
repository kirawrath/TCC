...
\agradecimento{Agradeço ao Goku por ter derrotado o Freeza, aos resumos da Thaís, e às pessoas que jogaram Magic comigo. Agradeço também aos happy hours e ao 9gag, pois sem eles eu teria me formado cedo demais.

Faço um agradecimento especial à todos os UFSCães por existirem, e ao RU por me manter vivo.
Eu também não poderia esquecer de agradecer ao stackoverflow, à todas as pessoas que fazem tutoriais com código de exemplo, e a todos os adoradores do software livre.

Finalmente, um beijo no coração para todos aqueles que desejam falir a Microsoft.
}
...
\textoResumo {
	...
	Este trabalho visa descrever e documentar como o sistema operacional EPOS foi portado para a plataforma Zedboard.
}
\palavrasChave {Systemas Operacionais. Portabilidade. EPOS.}
 
\textAbstract {
	In the operating systems field, there are a wide variety of different architectures, therefore an operating system must support a reasonable number of architectures in order to be implanted in a wide range of scenarios.
	EPOS operating system aims on portability, however the software-hardware interface inevitably must be rewritten for each platform.
	This work aims on describing and documenting how the operating system EPOS was ported to Zedboard's platform.
}
