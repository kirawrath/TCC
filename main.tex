...
O presente trabalho visa descrever como foi feito o porte do sistema operacional EPOS para a plataforma Zedboard, bem como comentar sobre as decisões tomadas e problemas enfrentados.
...
O cronômetro conta baseado em ciclos, não em tempo na unidade convencional (segundos, milisegundos, etc), portanto é necessário fazer uma conversão de unidades caso queira-se oferecer ao usuário a possibilidade de contar o tempo com unidades convencionais. A fórmula que converte esse valor é a seguinte \cite{technical_reference}:
